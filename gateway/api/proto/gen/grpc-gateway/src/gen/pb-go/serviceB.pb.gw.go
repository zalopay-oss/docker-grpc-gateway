...
/*
Package service_proto is a reverse proxy.
...
func request_ServiceB_Ping_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceBClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterServiceBHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServiceBClient) error {
	...
	mux.Handle("GET", pattern_ServiceB_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ServiceB_Ping_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ServiceB_Ping_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ServiceB_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"core", "serviceB", "ping", "timestamp"}, ""))
)

var (
	forward_ServiceB_Ping_0 = runtime.ForwardResponseMessage
)
